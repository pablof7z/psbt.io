...
<div class="fixed bottom-5 right-5 mb-5 flex flex-col item-end">
    ...
    {#if showChat}
        <div class="
            ...
            {#if !dismissedIntro}
                <h1 class="font-bold text-2xl text-purple-700">
                    NostrChat
                </h1>
    ...
    <div class="self-end">
        <a href="#" class="bg-purple-900 hover:bg-purple-700 w-full p-5 rounded-full flex-shrink-1 text-center font-semibold flex flex-row items-center gap-4" on:click|preventDefault={toggleChat}>
            <span class="tracking-wider">
                <span class="">Nostri</span><span class="text-orange-400 text-6xl -mx-1" style="line-height: 1px;">.</span><span class="text-purple-300">Chat</span>
            </span>
